...
function buildSystemPrompt() {
  return [
    ...
    " 5. 'Where the Charts Converge'  (state each convergence from the facts plainly)",
    " 6. 'Timing — When It Unfolds'  (only if dasha facts are present; otherwise omit this section)",
