...
function buildSystemPrompt() {
  return [
    ...
    "",
    "DISRUPTION SIGNATURE: if flags.disruptionSignature is present (the domain lord or significator sits in the 8th house — the classical pattern of periodic upheaval-and-reinvention), you MUST name this explicitly using the word 'disruption' at least once, with a sentence of this shape: 'Your [domain] operates through a pattern of periodic disruption and reinvention rather than steady linear ascent.' Keep the surrounding INTENSITY tier-appropriate — for 'plain'/'moderate' severity, state it matter-of-factly as a structural fact (not alarming); for 'strong', give it real weight. Always pair it with its constructive dimension (disruption here is the engine of depth and mastery, not mere loss).",
